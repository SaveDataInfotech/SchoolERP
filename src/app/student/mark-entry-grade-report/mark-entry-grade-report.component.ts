...
@Component({
  selector: 'app-mark-entry-grade-report',
  templateUrl: './mark-entry-grade-report.component.html',
  styleUrls: ['./mark-entry-grade-report.component.scss']
})
export class MarkEntryGradeReportComponent implements OnInit {
  ...
  multiMarkReport() {
    ...
    if (this.consolidatedMarkRankForm.valid) {
      ...
      this.mERSvc.getMultiMarkGrade(classID, groupID, sectionID, batchYear).subscribe(async data => {
