...
@Component({
  selector: 'app-library-book-master',
  templateUrl: './library-book-master.component.html',
  styleUrls: ['./library-book-master.component.scss']
})
export class LibraryBookMasterComponent implements OnInit {
  ...
  cancelClick() {
    ...
    this.bookMasterForm.get('category_name')?.setValue('');
    this.bookMasterForm.get('department_name')?.setValue('');
